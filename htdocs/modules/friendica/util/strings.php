...
$a->strings["Repair `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` Settings"] = "";
$a->strings["<strong>WARNING: This is highly advanced</strong> AND if you enter incorrectinformation your communications with this `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` may stop working."] = "";
$a->strings["Please use your browser 'Back' button <strong>now</strong> if you are uncertain what to do on this page."] = "";
$a->strings["Return to `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` editor"] = "";
$a->strings["Name"] = "";
...
$a->strings["everybody"] = "";
$a->strings["Contactinformation unavailable"] = "";
...
$a->strings["Thisintroduction has already been accepted."] = "";
$a->strings["Profile location is not valid or does not contain profileinformation."] = "";
...
$a->strings["You have alreadyintroduced yourself here."] = "";
$a->strings["Apparently you are already friends with %s."] = "";
$a->strings["Invalid profile URL."] = "";
$a->strings["Disallowed profile URL."] = "";
$a->strings["Failed to UPDATE `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` record."] = "";
$a->strings["Yourintroduction has been sent."] = "";
$a->strings["Please login to confirmintroduction."] = "";
$a->strings["Incorrect identity currently logged in. Please login to <strong>this</strong> profile."] = "";
$a->strings["Welcome home %s."] = "";
$a->strings["Please confirm yourintroduction/connection request to %s."] = "";
$a->strings["Confirm"] = "";
...
$a->strings["Please `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` your hosting provider or site administrator if you have questions about these settings."] = "";
...
$a->strings["isinterested in:"] = "";
$a->strings["Connect"] = "";
$a->strings["No matches"] = "";
$a->strings["Remote privacyinformation not available."] = "";
...
$a->strings["Hide this `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` FROM others"] = "";
...
$a->strings["Could not access `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` record."] = "";
...
$a->strings["%d `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`in common"] = array(
	0 => "",
	1 => "",
);
...
$a->strings["Contactinformation / Notes"] = "";
$a->strings["Edit `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` notes"] = "";
...
$a->strings["You receive anintroduction"] = "";
$a->strings["Yourintroductions are confirmed"] = "";
...
$a->strings["Enter your email accessinformation on your Connector Settings page if you wish to import AND interact with friends or mailing lists FROM your email INBOX"] = "";
...
$a->strings["Set some public keywords for your default profile which describe yourinterests. We may be able to find other people with similarinterests AND suggest friendships."] = "";
...
$a->strings["On the side panel of the Contacts page are several tools to find new friends. We can match people byinterest, look up people by name orinterest, AND provide suggestions based on network relationships. On a brand new site, friend suggestions will usually begin to be populated within 24 hours."] = "";
...
$a->strings["Click on a `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` to ADD or remove."] = "";
...
$a->strings["Please enter the requiredinformation."] = "";
$a->strings["Please use a shorter name."] = "";
$a->strings["Name too short."] = "";
...
$a->strings["Please `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` the sender by replying to this post if you do not wish to receive these messages."] = "";
...
$a->strings["Unable to locate `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`information."] = "";
...
$a->strings["The profile address specified does not provide adequateinformation."] = "";
...
$a->strings["Unable to retrieve `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`information."] = "";
$a->strings["following"] = "";
...
$a->strings["Contactinformation AND Social Networks"] = "";
$a->strings["Musicalinterests"] = "";
...
$a->strings["Unable to SET `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` photo."] = "";
...
$a->strings["Site public key not available in `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` record for URL %s."] = "";
$a->strings["The ID provided by your system is a duplicate on our system. It should work if you try again."] = "";
$a->strings["Unable to SET your `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` credentials on our system."] = "";
$a->strings["Unable to update your `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` profile details on our system"] = "";
...
$a->strings["Please `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` your site administrator.<br />The provided API URL is not valid."] = "";
$a->strings["We could not `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` the StatusNet API with the Path you entered."] = "";
...
$a->strings["<strong>Note</strong>: Due your privacy settings (<em>Hide your profile details FROM unknown viewers?</em>) the link potentially included in public postings relayed to StatusNet will lead the visitor to a blank pageinforming the visitor that the access to your profile has been restricted."] = "";
...
$a->strings["No consumer key pair for Twitter found. Please `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` your site administrator."] = "";
...
$a->strings["<strong>Note</strong>: Due your privacy settings (<em>Hide your profile details FROM unknown viewers?</em>) the link potentially included in public postings relayed to Twitter will lead the visitor to a blank pageinforming the visitor that the access to your profile has been restricted."] = "";
...
$a->strings["You've received anintroduction FROM %s at %s"] = "";
$a->strings["You've received %s FROM %s."] = "";
$a->strings["anintroduction"] = "";
$a->strings["You may visit their profile at %s"] = "";
$a->strings["Please visit %s to approve or reject theintroduction."] = "";
