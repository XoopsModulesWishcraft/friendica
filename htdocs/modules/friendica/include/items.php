...
require_once($GLOBALS['xoops']->path("/modules/friendica/include/oembed.php"));
...
function get_feed_for(&$a, $dfrn_id, $owner_nick, $last_update, $direction = 0) {
	...
	$r = q("SELECT `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.*, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "user") . "`.`uid` AS `user_uid`, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "user") . "`.`nickname`, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "user") . "`.`timezone`
		...
		WHERE `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`self` = 1 AND `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "user") . "`.`nickname` = %s LIMIT 1",
		dbesc($owner_nick)
	);
	...
	if(! $public_feed) {
		...
		$r = q("SELECT * FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` WHERE `blocked` = 0 AND `pending` = 0 AND `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`uid` = %d $sql_extra LIMIT 1",
			intval($owner_id)
		);
	...
	$r = q("SELECT `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.*, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`id` AS `item_id`, 
		`" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`name`, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`photo` , `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`url`, 
		`" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`name-date`, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`uri-date`, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`avatar-date`,
		`" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`thumb`, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`dfrn-id`, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`self`, 
		`" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`id` AS `contact-id`, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`uid` AS `contact-uid`,
		`" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "sign") . "`.`signed_text`, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "sign") . "`.`signature`, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "sign") . "`.`signer`
		...
		LEFT JOIN `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "sign") . "` ON `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "sign") . "`.`iid` = `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`id`
		WHERE `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`uid` = %d AND `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`visible` = 1 AND `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`moderated` = 0 AND `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`parent` != 0 
		AND `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`wall` = 1 AND `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`blocked` = 0 AND `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`pending` = 0
		AND ( `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`edited` > %s OR `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`changed` > %s )
		$sql_extra
...
function get_atom_elements($feed,$item) {
	...
	require_once($GLOBALS['xoops']->path("/modules/friendica/library/HTMLPurifier.auto.php"));
	require_once($GLOBALS['xoops']->path("/modules/friendica/include/html2bbcode.php"));
	...
	if($rawobj) {
		...
		if($rawobj[0]['child'][SIMPLEPIE_NAMESPACE_ATOM_10]['content'][0]['data']) {
			...
			// preserve a copy of the original body content in case we later need to parse out any microformatinformation, e.g. events
...
function item_store($arr,$force_parent = false) {
	...
	if($arr['parent-uri'] === $arr['uri']) {
		...
		$r = q("SELECT * FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` WHERE `uri` = %s AND `uid` = %d ORDER BY `id` ASC LIMIT 1",
		...
		if(count($r)) {
			...
			if($r[0]['uri'] != $r[0]['parent-uri']) {
				...
				$z = q("SELECT `id` FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` WHERE `uri` = %s AND `parent-uri` = %s AND `uid` = %d 
	...
	$r = q("SELECT `id` FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` WHERE `uri` = %s AND `uid` = %d LIMIT 1",
		dbesc($arr['uri']),
		intval($arr['uid'])
	);
	if($r  &&  count($r)) {
	...
	$r = dbq("INSERT INTO `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` ( `" 
	...
	$r = q("SELECT `id` FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` WHERE `uri` = %s AND `uid` = %d ORDER BY `id` ASC ",
	...
	if(count($r) > 1) {
		...
		q("DELETE FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` WHERE `uri` = %s AND `uid` = %d AND `id` != %d ",
			$arr['uri'],
			intval($arr['uid']),
			intval($current_post)
		);
	...
	$r = q("UPDATE  `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` SET `parent` = %d, `allow_cid` = %s, `allow_gid` = %s,
	...
	q("UPDATE  `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` SET `commented` = %s, `changed` = %s WHERE `id` = %d LIMIT 1",
	...
	if($dsprsig) {
		q("INSERT INTO `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "sign") . "` ( `iid`, `signed_text`, `signature`, `signer` ) values (%d, %s, %s, %s) ",
			intval($current_post),
	...
	if($arr['last-child']) {
		$r = q("UPDATE  `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` SET `last-child` = 0 WHERE `parent-uri` = %s AND `uid` = %d AND `id` != %d",
			dbesc($arr['uri']),
			intval($arr['uid']),
			intval($current_post)
		);
...
function tag_deliver($uid,$item_id) {
	...
	$u = q("SELECT uid, nickname, language, username, email, `page-flags`, `notify-flags` FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "user") . "` WHERE uid = %d LIMIT 1",
		intval($uid)
	);
	if(! count($u))
		return;
	...
	$i = q("SELECT * FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` WHERE id = %d AND uid = %d LIMIT 1",
		intval($item_id),
		intval($uid)
	);
	if(! count($i))
	...
	$c = q("SELECT name, url, thumb FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` WHERE self = 1 AND uid = %d LIMIT 1",
		intval($u[0]['uid'])
	);
	if(! count($c))
		return;

	q("UPDATE `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` SET wall = 1, origin = 1, forum_mode = 1, `owner-name` = %s, `owner-link` = %s, `owner-avatar` = %s  WHERE id = %d LIMIT 1",
		dbesc($c[0]['name']),
		dbesc($c[0]['url']),
		dbesc($c[0]['thumb']),
		intval($item_id)
 ...
 *             FROM an external network AND MAY create an appropriate `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` record. Otherwise, we MUST 
 *             have a `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` record.
...
function consume_feed($xml,$importer,&$contact, &$hub, $datedir = 0, $pass = 0) {
	...
	// Check at the feed level for updated `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` name and/or photo
	...
	if((is_array($contact))  &&  ($photo_timestamp)  &&  (strlen($photo_url))  &&  ($photo_timestamp > $contact['avatar-date'])) {
		...
		$r = q("SELECT `resource-id` FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "photo") . "` WHERE `contact-id` = %d AND `uid` = %d LIMIT 1",
			intval($contact['id']),
			intval($contact['uid'])
		);
		if(count($r)) {
		...
		if($img->is_valid()) {
			if($have_photo) {
				q("DELETE FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "photo") . "` WHERE `resource-id` = %s AND `contact-id` = %d AND `uid` = %d",
					dbesc($resource_id),
					intval($contact['id']),
					intval($contact['uid'])
				);
			...
			q("UPDATE `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` SET `avatar-date` = %s, `photo` = %s, `thumb` = %s, `micro` = %s
	...
	if((is_array($contact))  &&  ($name_updated)  &&  (strlen($new_name))  &&  ($name_updated > $contact['name-date'])) {
		$r = q("SELECT * FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` WHERE uid = %d AND id = %d LIMIT 1",
			intval($contact['uid']),
			intval($contact['id'])
		);

		$x = q("UPDATE `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` SET `name` = %s, `name-date` = %s WHERE `uid` = %d AND `id` = %d LIMIT 1",
		...
		if(count($r)) {
			q("UPDATE `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` SET `author-name` = %s WHERE `author-name` = %s AND `author-link` = %s AND uid = %d",
				dbesc(notags(trim($new_name))),
				dbesc($r[0]['name']),
				dbesc($r[0]['url']),
				intval($contact['uid'])
	...
	if(strlen($birthday)) {
		if(substr($birthday,0,4) != $contact['bdyear']) {
			...
			$r = q("INSERT INTO `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "event") . "` ( `uid`, `cid`, `created`, `edited`, `start`, `finish`, `desc`, `type` )
			...
			q("UPDATE `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` SET `bdyear` = %s WHERE `uid` = %d AND `id` = %d LIMIT 1",
	...
	if(is_array($del_entries)  &&  count($del_entries)  &&  $pass != 2) {
		foreach($del_entries as $dentry) {
			...
			if($deleted  &&  is_array($contact)) {
				$r = q("SELECT `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.*, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`self` FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` LEFT JOIN `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` ON `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`contact-id` = `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`id`
					WHERE `uri` = %s AND `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`uid` = %d AND `contact-id` = %d LIMIT 1",
					dbesc($uri),
					intval($importer['uid']),
					intval($contact['id'])
				);
				if(count($r)) {
					...
					if(($item['verb'] === ACTIVITY_TAG)  &&  ($item['object-type'] === ACTVITY_OBJ_TAGTERM)) {
						...
						if($xt->type === ACTIVITY_OBJ_NOTE) {
							$i = q("SELECT * FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` WHERE uri = %s AND uid = %d LIMIT 1", dbesc($xt->id), intval($importer['importer_uid']));
							if(count($i)) {
								...
								if($author_remove || $owner_remove) {
									...
									q("UPDATE `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` SET tag = %s WHERE id = %d LIMIT 1",
					...
					if($item['uri'] == $item['parent-uri']) {
						$r = q("UPDATE  `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` SET `deleted` = 1, `edited` = %s, `changed` = %s,
							`body` = '', `title` = ''
						...
						if($item['last-child']) {
							...
							q("UPDATE  `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` SET `last-child` = 0, `changed` = %s WHERE `parent-uri` = %s AND `uid` = %d ",
								dbesc(datetime_convert()),
								dbesc($item['parent-uri']),
								intval($item['uid'])
							);
							// who is the last child now? 
							$r = q("SELECT `id` FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` WHERE `parent-uri` = %s AND `type` != 'activity' AND `deleted` = 0 AND `moderated` = 0 AND `uid` = %d 
		...
		foreach($items as $item) {
			...
			if(($is_reply)  &&  is_array($contact)) {
				...
				if((! x($datarray,'author-name')) || (! x($datarray,'author-link'))) {
					logger('consume_feed: no authorinformation! ' . print_r($datarray,true));
					continue;
				}

				$r = q("SELECT `uid`, `last-child`, `edited`, `body` FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` WHERE `uri` = %s AND `uid` = %d LIMIT 1",
					dbesc($item_id),
					intval($importer['uid'])
				);
				...
				if(count($r)) {
					if((x($datarray,'edited') !== false)  &&  (datetime_convert('UTC','UTC',$datarray['edited']) !== $r[0]['edited'])) {  
						$r = q("UPDATE  `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` SET `title` = %s, `body` = %s, `edited` = %s WHERE `uri` = %s AND `uid` = %d LIMIT 1",
					...
					if(($allow)  &&  ($allow[0]['data'] != $r[0]['last-child'])) {
						$r = q("UPDATE  `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` SET `last-child` = 0, `changed` = %s WHERE `parent-uri` = %s AND `uid` = %d",
							dbesc(datetime_convert()),
							dbesc($parent_uri),
							intval($importer['uid'])
						);
						$r = q("UPDATE  `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` SET `last-child` = %d , `changed` = %s  WHERE `uri` = %s AND `uid` = %d LIMIT 1",
							intval($allow[0]['data']),
							dbesc(datetime_convert()),
							dbesc($item_id),
							intval($importer['uid'])
				...
				if((activity_match($datarray['verb'],ACTIVITY_LIKE)) || (activity_match($datarray['verb'],ACTIVITY_DISLIKE))) {
					...
					$r = q("SELECT id FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` WHERE uid = %d AND `contact-id` = %d AND verb =%s AND deleted = 0 LIMIT 1",
						intval($datarray['uid']),
				...
				if(($datarray['verb'] === ACTIVITY_TAG)  &&  ($datarray['object-type'] === ACTIVITY_OBJ_TAGTERM)) {
					...
					if($xt->type == ACTIVITY_OBJ_NOTE) {
						$r = q("SELECT * FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` WHERE `uri` = %s AND `uid` = %d LIMIT 1",
							dbesc($xt->id),
				...
				if((x($datarray,'object-type'))  &&  ($datarray['object-type'] === ACTIVITY_OBJ_EVENT)) {
					...
					if(x($ev,'desc')  &&  x($ev,'start')) {
						...
						if(is_array($contact))
							$ev['cid'] = $contact['id'];
						$r = q("SELECT * FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "event") . "` WHERE `uri` = %s AND `uid` = %d LIMIT 1",
							dbesc($item_id),
							intval($importer['uid'])
						);
						if(count($r))
				...
				// This is my `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` on another system, but it's really me.
				...
				if(x($datarray,'owner-link')  &&  strlen($datarray['owner-link'])  &&  (! link_compare($datarray['owner-link'],$contact['url']))) {
					...
					// the tgroup delivery code called FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`_store will correct it if it's a forum,
...
function local_delivery($importer,$data) {
	...
	if(isset($sugg[0]['child'][NAMESPACE_DFRN])) {
		...
		$r = q("SELECT * FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` WHERE `name` = %s AND `nurl` = %s AND `uid` = %d LIMIT 1",
			dbesc($fsugg['name']),
		...
		$fid = 0;
		$r = q("SELECT * FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "fcontact") . "` WHERE `url` = %s AND `name` = %s AND `request` = %s LIMIT 1",
			dbesc($fsugg['url']),
			dbesc($fsugg['name']),
			dbesc($fsugg['request'])
		);
		...
		if(! $fid)
			$r = q("INSERT INTO " . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "fcontact") . "` ( `name`, `url`, `photo`, `request` ) VALUES ( %s, %s, %s, %s ) ", dbesc($fsugg['name']), dbesc($fsugg['url']), dbesc($fsugg['photo']), dbesc($fsugg['request']));
		$r = q("SELECT * FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "fcontact") . "` WHERE `url` = %s AND `name` = %s AND `request` = %s LIMIT 1",
			dbesc($fsugg['url']),
			dbesc($fsugg['name']),
			dbesc($fsugg['request'])
		...
		$r = q("INSERT INTO `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "intro") . "` ( `uid`, `fid`, `contact-id`, `note`, `hash`, `datetime`, `blocked` ) 
	...
	if(isset($rawmail[0]['child'][NAMESPACE_DFRN])) {
		...
		$r = dbq("INSERT INTO `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "mail") . "` ( `" . implode( "`, `", array_keys($msg)) . "` ) VALUES ('" . implode("', '", array_values($msg)) . "')" );
			...
			if($deleted) {
				...
				if(count($r)) {
					...
					if(($item['verb'] === ACTIVITY_TAG)  &&  ($item['object-type'] === ACTVITY_OBJ_TAGTERM)) {
						...
						$xt = parse_xml_string($item['target'],false);
						if($xt->type === ACTIVITY_OBJ_NOTE) {
							$i = q("SELECT * FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` WHERE uri = %s AND uid = %d LIMIT 1",
								dbesc($xt->id),
								intval($importer['importer_uid'])
							);
							if(count($i)) {
					...
					if($item['uri'] == $item['parent-uri']) {
						...
						if($item['last-child']) {
							...
							// who is the last child now? 
							$r = q("SELECT `id` FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` WHERE `parent-uri` = %s AND `type` != 'activity' AND `deleted` = 0 AND `uid` = %d
								ORDER BY `created` DESC LIMIT 1",
									dbesc($item['parent-uri']),
									intval($importer['importer_uid'])
							);
	...
	foreach($feed->get_items() as $item) {
		...
		if($is_reply) {
			...
			$r = q("SELECT `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`id`, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`uri`, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`tag`, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`forum_mode`, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`origin`, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`wall`, 
				`" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`name`, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`url`, `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`thumb` FROM `item`
				LEFT JOIN `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` ON `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "`.`id` = `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`contact-id`
				WHERE `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`uri` = %s AND `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`parent-uri` = %s
				AND `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "`.`uid` = %d 
				$sql_extra
				LIMIT 1",
				dbesc($parent_uri),
				dbesc($parent_uri),
				...
				if(($datarray['verb'] === ACTIVITY_TAG)  &&  ($datarray['object-type'] === ACTIVITY_OBJ_TAGTERM)) {
					...
					if(($xt->type == ACTIVITY_OBJ_NOTE)  &&  ($xt->id == $r[0]['uri'])) {
						...
						if($xo->id  &&  $xo->content) {
							...
							if(! (stristr($r[0]['tag'],$newtag))) {
								$i = q("SELECT `blocktags` FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "user") . "` WHERE `uid` = %d LIMIT 1",
									intval($importer['importer_uid'])
								);
...
//				}
				...
				if($posted_id) {
					$r = q("SELECT `parent` FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` WHERE `id` = %d AND `uid` = %d LIMIT 1",
						intval($posted_id),
						intval($importer['importer_uid'])
					);
					if(count($r))
					...
					if(! $is_like) {
						$r1 = q("UPDATE  `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` SET `last-child` = 0, `changed` = %s WHERE `uid` = %d AND `parent` = %d",
							dbesc(datetime_convert()),
							intval($importer['importer_uid']),
							intval($r[0]['parent'])
						);

						$r2 = q("UPDATE  `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` SET `last-child` = 1, `changed` = %s WHERE `uid` = %d AND `id` = %d LIMIT 1",
							dbesc(datetime_convert()),
							intval($importer['importer_uid']),
							intval($posted_id)
						);
				...
				if($datarray['type'] != 'activity') {
					...
					$myconv = q("SELECT `author-link`, `author-avatar`, `parent` FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` WHERE `parent-uri` = %s AND `uid` = %d AND `parent` != 0 ",
						dbesc($parent_uri),
						intval($importer['importer_uid'])
					);
...
function new_follower($importer,$contact,$datarray,$item,$sharing = false) {
	...
	if(is_array($contact)) {
		if(($contact['network'] == NETWORK_OSTATUS  &&  $contact['rel'] == CONTACT_IS_SHARING)
			...
			$r = q("UPDATE `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` SET `rel` = %d WHERE `id` = %d AND `uid` = %d LIMIT 1",
		...
		$r = q("INSERT INTO `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact")  . "` ( `uid`, `created`, `url`, `nurl`, `name`, `nick`, `photo`, `network`, `rel`, 
		...
		$r = q("SELECT `id` FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` WHERE `uid` = %d AND `url` = %s AND `pending` = 1 LIMIT 1",
				intval($importer['uid']),
				dbesc($url)
		);
		if(count($r))
		...
		if(is_array($contact_record)) {
			$ret = q("INSERT INTO `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "intro") . "` ( `uid`, `contact-id`, `blocked`, `knowyou`, `hash`, `datetime` )
				VALUES ( %d, %d, 0, 0, %s, %s )",
				intval($importer['uid']),
...
function lose_follower($importer,$contact,$datarray,$item) {
	...
	if(($contact['rel'] == CONTACT_IS_FRIEND) || ($contact['rel'] == CONTACT_IS_SHARING)) {
		q("UPDATE `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` SET `rel` = %d WHERE `id` = %d LIMIT 1",
...
function subscribe_to_hub($url,$importer,$contact,$hubmode = 'subscribe') {
	...
	if(! strlen($contact['hub-verify'])) {
		$r = q("UPDATE `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` SET `hub-verify` = %s WHERE `id` = %d LIMIT 1",
			dbesc($verify_token),
			intval($contact['id'])
		);
	}
	...
	if(preg_match("/\[img\](.*?)\[\/img\]/is",$s,$matches)) {
		...
		if(stristr($image ,$a->get_baseurl() . '/photo/')) {
			...
			if($x) {
				$res = substr($i,$x+1);
				$i = substr($i,0,$x);
				$r = q("SELECT * FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "photo") . "` WHERE `resource-id` = %s AND `scale` = %d AND `uid` = %d",
					dbesc($i),
					intval($res),
					intval($uid)
				);
...
function item_expire($uid,$days) {
	...
	$r = q("SELECT * FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` 
		WHERE `uid` = %d 
	...
	foreach($r as $item) {
		...
		$r = q("UPDATE  `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` SET `deleted` = 1, `edited` = %s, `changed` = %s WHERE `id` = %d LIMIT 1",
			dbesc(datetime_convert()),
			dbesc(datetime_convert()),
			intval($item['id'])
		);
		...
		$r = q("UPDATE  `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` SET `deleted` = 1, `edited` = %s, `changed` = %s WHERE `parent-uri` = %s AND `uid` = %d ",
			dbesc(datetime_convert()),
			dbesc(datetime_convert()),
			dbesc($item['parent-uri']),
			intval($item['uid'])
...
function drop_item($id,$interactive = true) {
	...
	$r = q("SELECT * FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` WHERE `id` = %d LIMIT 1",
		intval($id)
	);
	...
	if((local_user() == $item['uid']) || (remote_user() == $item['contact-id'])) {
		...
		$r = q("UPDATE  `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` SET `deleted` = 1, `title` = '', `body` = '', `edited` = %s, `changed` = %s WHERE `id` = %d LIMIT 1",
			dbesc(datetime_convert()),
			dbesc(datetime_convert()),
			intval($item['id'])
		);
		...
		if(strlen($item['resource-id'])) {
			q("DELETE FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "photo") . "` WHERE `resource-id` = %s AND `uid` = %d ",
		...
		if(intval($item['event-id'])) {
			q("DELETE FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "event") . "` WHERE `id` = %d AND `uid` = %d LIMIT 1",
		...
		if($item['uri'] == $item['parent-uri']) {
			$r = q("UPDATE  `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` SET `deleted` = 1, `edited` = %s, `changed` = %s, `body` = '' , `title` = ''
				WHERE `parent-uri` = %s AND `uid` = %d ",
				dbesc(datetime_convert()),
				dbesc(datetime_convert()),
				dbesc($item['parent-uri']),
			...
			// who is the last child now? 
			$r = q("SELECT `id` FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "item") . "` WHERE `parent-uri` = %s AND `type` != 'activity' AND `deleted` = 0 AND `uid` = %d ORDER BY `edited` DESC LIMIT 1",
				dbesc($item['parent-uri']),
				intval($item['uid'])
			);
			if(count($r)) {
