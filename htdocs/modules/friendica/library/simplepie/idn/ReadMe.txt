...
// Include the class
include_once($GLOBALS['xoops']->path("/modules/friendica/idna_convert.class.php"));
// Instantiate it *
...
In case of errors, bugs, questions, wishes, please don't hesitate to `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` us
