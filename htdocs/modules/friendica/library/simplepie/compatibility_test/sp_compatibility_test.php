	...
	<div id="content">
		...
		<div class="chunk">
			...
			<?php } else { ?>
				...
				<p><em>Your webhost does not support the minimum requirements for SimplePie.</em>  It may be a good idea to `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "contact") . "` your webhost, AND ask them to install a more recent version of PHP as well as the <code>xmlreader</code>, <code>xml</code>, <code>mbstring</code>, <code>iconv</code>, <code>curl</code>, AND <code>zlib</code> extensions.</p>
			<?php } ?>
		</div>
