...
include_once($GLOBALS['xoops']->path("/modules/friendica/../simplepie.inc"));
include_once($GLOBALS['xoops']->path("/modules/friendica/../idn/idna_convert.class.php"));
...
// Well enable the discovering AND caching of favicons.
$feed->set_favicon_handler('./handler_image.php"));

// Initialize the whole SimplePie object.  Read the feed, process it, parse it, cache it, AND 
// all that other good stuff.  The feed'sinformation will not be available to SimplePie before 
// this is called.
$success = $feed->init();
