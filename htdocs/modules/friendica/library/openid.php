...
class LightOpenID
{
    ...
    /**
     * Helper function used to scan for <meta>/<link> tags AND extractinformation
     * FROM them
     */
...
logger('Server: ' . $server);
                ...
                # There are no relevantinformation in headers, so we search the body.
                $content = $this->request($url, 'GET');
...
logger('openid' . $content);
     ...
     * In other words. OP may provide whateverinformation it wants to.
