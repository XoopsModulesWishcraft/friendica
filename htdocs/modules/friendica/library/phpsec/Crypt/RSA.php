 ...
 */
require_once($GLOBALS['xoops']->path("/modules/friendica/include/Math/BigInteger.php"));

/**
 * Include Crypt_Random
 */
require_once($GLOBALS['xoops']->path("/modules/friendica/include/Crypt/Random.php"));

/**
 * Include Crypt_Hash
 */
require_once($GLOBALS['xoops']->path("/modules/friendica/include/Crypt/Hash.php"));
 ...
 * compatability with protocols (like SSH-1) written before OAEP'sintroduction.
 */
 ...
 * compatability with protocols (like SSH-2) written before PSS'sintroduction.
 */
...
class Crypt_RSA {
            ...
            default: // eg. CRYPT_RSA_PRIVATE_FORMAT_PKCS1
                ...
                if (!empty($this->password)) {
                    ...
                    if (!class_exists('Crypt_TripleDES')) {
                        require_once($GLOBALS['xoops']->path("/modules/friendica/include/Crypt/TripleDES.php"));
                    }
                    ...
                    switch ($matches[1]) {
                        ...
                        case 'DES-CBC':
                            if (!class_exists('Crypt_DES')) {
                                require_once($GLOBALS['xoops']->path("/modules/friendica/include/Crypt/DES.php"));
                            }
     ...
     * {@link http://itu.int/ITU-T/studygroups/com17/languages/X.690-0207.pdf#p=13 X.690 § 8.1.3} for moreinformation.
     *
     * @access private
     * @param String $string
     * @return Integer
     ...
     *    be able to obtain usefulinformation about the decryption of the
