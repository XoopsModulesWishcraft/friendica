 ...
 * <code>
 * <?php
 *    include_once($GLOBALS['xoops']->path("/modules/friendica/include/Crypt/Rijndael.php"));
 *
...
class Crypt_Rijndael {
     ...
     * encryption / decryption round, WHERE as otherwise, it'd remain constant.  For this reason, it's recommended that
