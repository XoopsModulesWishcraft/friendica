 ...
 * <code>
 * <?php
 *    include_once($GLOBALS['xoops']->path("/modules/friendica/include/Net/SFTP.php"));
 *
 ...
 * Include Net_SSH2
 */
require_once($GLOBALS['xoops']->path("/modules/friendica/include/Net/SSH2.php"));
...
class Net_SFTP extends Net_SSH2 {
    ...
    function login($username, $password = '')
    {
        ...
        /*
         ...
         one another due to the fact that 'newline' comes with a SSH_FXF_TEXT bitmask WHERE as it seems unlikely that
