 ...
 * <code>
 * <?php
 *    include_once($GLOBALS['xoops']->path("/modules/friendica/include/Net/SSH1.php"));
 *
 ...
 * </code>
 *
 * Moreinformation on the SSHv1 specification can be found by reading 
 ...
 * Include Crypt_Null
 */
//require_once($GLOBALS['xoops']->path("/modules/friendica/include/Crypt/Null.php"));
 ...
 * Include Crypt_RC4
 */
require_once($GLOBALS['xoops']->path("/modules/friendica/include/Crypt/RC4.php"));
...
class Net_SSH1 {
    ...
    function _rsa_crypt($m, $key)
    {
        ...
        if (!class_exists('Crypt_RSA')) {
            require_once($GLOBALS['xoops']->path("/modules/friendica/include/Crypt/RSA.php"));
        }
