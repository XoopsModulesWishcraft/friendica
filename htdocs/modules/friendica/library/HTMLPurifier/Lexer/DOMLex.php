 ...
 * into a DOM, AND then into the `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "tokens") . "`.  It is blazingly fast (for large
...
class HTMLPurifier_Lexer_DOMLex extends HTMLPurifier_Lexer
{
     ...
     * @param $tokens   Array-list of already tokenized `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "tokens") . "`.
     * @param $collect  Says whether or start AND close are collected, SET to
     *                  false at first recursion because it's the implicit DIV
     *                  tag you're dealing with.
     * @returns Tokens of node appended to previously passed `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "tokens") . "`.
     */
