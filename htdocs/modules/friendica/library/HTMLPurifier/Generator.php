...
/**
 * Generates HTML FROM `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "tokens") . "`.
...
class HTMLPurifier_Generator
{
    ...
    /**
     * Stack for keeping track of objectinformation when outputting IE
     * compatibility code.
     */
    ...
    /**
     * Generates HTML FROM an array of `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "tokens") . "`.
