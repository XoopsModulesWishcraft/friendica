...
/**
 * Forgivingly lexes HTML (SGML-style) markup into `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "tokens") . "`.
 *
 * A lexer parses a string of SGML-style markup AND converts them into
 * corresponding `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "tokens") . "`.  It doesn't check for well-formedness, although its
...
class HTMLPurifier_Lexer
{
    ...
    /**
     * Lexes an HTML string into `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "tokens") . "`.
     *
