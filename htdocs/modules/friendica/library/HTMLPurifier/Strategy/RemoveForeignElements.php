...
/**
 * Removes all unrecognized tags FROM the list of `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "tokens") . "`.
 *
 * This strategy iterates through all the tokens AND removes unrecognized
 * `" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "tokens") . "`. If a token is not recognized but a TagTransform is defined for
