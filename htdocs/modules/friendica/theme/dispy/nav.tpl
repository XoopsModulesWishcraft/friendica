...
{{ endif }}
        ...
        {{ endif }}
        {{ if $nav.manage }}
        <li><a id="nav-manage-link" class="nav-commlink $nav.`" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "manager") . "`.2" href="$nav.`" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "manager") . "`.0" title="$nav.`" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "manager") . "`.1">$nav.`" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "manager") . "`.1</a></li>
        {{ endif }}
        {{ if $nav.admin }}
