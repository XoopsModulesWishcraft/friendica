<nav>
	...
	{{ if $nav.manage }}<a id="nav-manage-link" class="nav-commlink $nav.`" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "manager") . "`.2 $sel.manage" href="$nav.`" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "manager") . "`.0" title="$nav.`" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "manager") . "`.3">$nav.`" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "manager") . "`.1</a>{{ endif }}
