...
<!--		{{ if $nav.notifications }}<a id="intro-update" class="nav-ajax-update" href="$nav.notifications.0" title="$nav.notifications.1"></a>{{ endif }} -->
	...
	<div id="user-menu" >
		...
		<ul id="user-menu-popup" 
			...
			{{ if $nav.manage }}<li><a id="nav-manage-link" class="nav-commlink $nav.`" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "manager") . "`.2" href="$nav.`" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "manager") . "`.0">$nav.`" . $GLOBALS['xoopsDB']->prefix(_MI_FDC_MODULE_DB_PREFIX . "manager") . "`.1</a></li>{{ endif }}
