...
$a->strings["The profile address specified does not provide adequateinformation."] = "L'indirizzo del profilo specificato non fornisce adeguateinformazioni.";
...
$a->strings["Unable to retrieve contactinformation."] = "Impossibile recuperareinformazioni sul contatto.";
...
$a->strings["Contactinformation AND Social Networks"] = "Informazioni su contatti e Social network";
$a->strings["Musicalinterests"] = "Interessi musicali";
...
$a->strings["You receive anintroduction"] = "Ricevi una presentazione";
$a->strings["Yourintroductions are confirmed"] = "Le tue presentazioni sono confermate";
...
$a->strings["Contactinformation unavailable"] = "Informazione sul contatto non disponibile";
...
$a->strings["Set some public keywords for your default profile which describe yourinterests. We may be able to find other people with similarinterests AND suggest friendships."] = "Inserisci qualche parola chiave pubblica nel tuo profilo predefinito che descriva i tuoi interessi. Potremmo essere in grado di trovare altre persone con interessi similari e suggerirti delle amicizie.";
...
$a->strings["Contactinformation / Notes"] = "Informazioni / Note sul contatto";
...
$a->strings["Remote privacyinformation not available."] = "Informazioni remote sulla privacy non disponibili.";
...
$a->strings["Please enter the requiredinformation."] = "Inserisci leinformazioni richieste.";
$a->strings["Please use a shorter name."] = "Usa un nome più corto.";
...
$a->strings["Registration successful. Please check your email for further instructions."] = "Registrazione completata. Controlla la tua mail per ulterioriinformazioni.";
...
$a->strings["<strong>WARNING: This is highly advanced</strong> AND if you enter incorrectinformation your communications with this contact may stop working."] = "<strong>ATTENZIONE: Queste sono impostazioni avanzate</strong> e se inserisciinformazioni errate le tue comunicazioni con questo contatto potrebbero non funzionare più";
...
$a->strings["Thisintroduction has already been accepted."] = "Questa presentazione è già stata accettata.";
$a->strings["Profile location is not valid or does not contain profileinformation."] = "La posizione del profilo non è valida o non contieneinformazioni di profilo.";
...
$a->strings["You have alreadyintroduced yourself here."] = "Ti sei già presentato qui.";
...
$a->strings["Yourintroduction has been sent."] = "La tua presentazione è stata inviata.";
$a->strings["Please login to confirmintroduction."] = "Accedi per confermare la presentazione.";
...
$a->strings["Please confirm yourintroduction/connection request to %s."] = "Conferma la tua richiesta di connessione con %s.";
$a->strings["Confirm"] = "Conferma";
...
$a->strings["Unable to locate contactinformation."] = "Impossibile trovare leinformazioni del contatto.";
...
$a->strings["image/photo"] = "immagine / foto";
$a->strings["Cannot locate DNS info for database server %s"] = "Non trovo leinformazioni DNS per il database server %s";
