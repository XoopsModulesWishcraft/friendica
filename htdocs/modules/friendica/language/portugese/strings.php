...
$a->strings["<strong>WARNING: This is highly advanced</strong> AND if you enter incorrectinformation your communications with this contact will stop working."] = "<strong>AVISO: Essas são configurações mais avançadas</strong> e caso você entre com algumainformação incorreta, suas comunicações com este contato deixarão de funcionar.";
...
$a->strings["Contactinformation unavailable"] = "Ainformação de contato não está disponível";
...
$a->strings["Thisintroduction has already been accepted."] = "Estaintrodução já foi aceita.";
$a->strings["Profile location is not valid or does not contain profileinformation."] = "A localização do perfil não é válida ou não contéminformação de perfil.";
...
$a->strings["introduction complete."] = "Aintrodução foi completada.";
...
$a->strings["You have alreadyintroduced yourself here."] = "Você já fez a suaintrodução aqui.";
...
$a->strings["Yourintroduction has been sent."] = "A suaintrodução foi enviada.";
$a->strings["Please login to confirmintroduction."] = "Por favor, autentique-se para confirmar aintrodução.";
...
$a->strings["Please confirm yourintroduction/connection request to %s."] = "Por favor, confirme sua solicitação deintrodução/conexão para %s.";
...
$a->strings["Please answer the following:"] = "Por favor, entre com asinformações solicitadas:";
...
$a->strings["Remote privacyinformation not available."] = "Não existeinformação disponível sobre a privacidade remota.";
...
$a->strings["Find People With Sharedinterests"] = "Encontre pessoas com interesses similares";
...
$a->strings["Contactinformation / Notes"] = "Informações de contato / Notas";
...
$a->strings["You receive anintroduction"] = "Você receber uma solicitação";
$a->strings["Yourintroductions are confirmed"] = "Suas solicitações forem confirmadas";
...
$a->strings["Please enter the requiredinformation."] = "Por favor, forneça ainformação solicitada.";
$a->strings["Please use a shorter name."] = "Por favor, use um nome mais curto.";
$a->strings["Name too short."] = "O nome é muito curto.";
...
$a->strings["Registration successful. Please check your email for further instructions."] = "O registro foi bem sucedido. Por favor, verifique seu e-mail para maioresinformações.";
...
$a->strings["Unable to locate contactinformation."] = "Não foi possível localizarinformação do contato.";
...
$a->strings["The profile address specified does not provide adequateinformation."] = "O endereço de perfil especificado não forneceinformação adequada.";
...
$a->strings["Unable to retrieve contactinformation."] = "Não foi possível recuperar ainformação do contato.";
...
$a->strings["Profile Name is required."] = "É necessárioinformar o nome do perfil.";
...
$a->strings["Contactinformation AND Social Networks"] = "Informações de contato e redes sociais";
$a->strings["Musicalinterests"] = "Interesses musicais";
...
$a->strings["introduction failed or was revoked."] = "Ocorreu uma falha naintrodução ou ela foi revogada.";
...
$a->strings["We could not contact the StatusNet API with the Path you entered."] = "Não foi possível contactar a API do StatusNet a partir do caminho que vocêinformou.";
...
$a->strings["Cannot locate DNS info for database server %s"] = "Não foi possível localizar ainformação de DNS para o servidor de banco de dados %s";
$a->strings["Visible To:"] = "Visível para:";
$a->strings["everybody"] = "todos";
