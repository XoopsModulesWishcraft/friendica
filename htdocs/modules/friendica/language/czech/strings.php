...
$a->strings["<strong>WARNING: This is highly advanced</strong> AND if you enter incorrectinformation your communications with this contact will stop working."] = "<strong>VAROVÁNÍ: Toto je velmi pokročilé nastavení,</strong> pokud zadáte nesprávnéinformace, komunikace s tímto kontaktem přestane fungovat.";
...
$a->strings["Contactinformation unavailable"] = "Kontakt byl zablokován";
...
$a->strings["Thisintroduction has already been accepted."] = "Toto pozvání již bylo přijato";
$a->strings["Profile location is not valid or does not contain profileinformation."] = "Adresa profilu není platná nebo neobsahuje profilovéinformace";
...
$a->strings["You have alreadyintroduced yourself here."] = "Již jste se zde zavedli.";
...
$a->strings["Yourintroduction has been sent."] = "Vaše žádost o propojení byla odeslána.";
$a->strings["Please login to confirmintroduction."] = "Prosím přihlašte se k potvrzení žádosti o propojení.";
...
$a->strings["Please confirm yourintroduction/connection request to %s."] = "Prosím potvrďte Vaši žádost o představení/spojení %s.";
...
$a->strings["Please see the file \"install.txt\"."] = "Přečtěte si prosíminformace v souboru \"install.txt\".";
...
$a->strings["Remote privacyinformation not available."] = "Vzdálené soukroméinformace nejsou k dispozici.";
...
$a->strings["Find People With Sharedinterests"] = "Najít lidi se společnými zájmy";
...
$a->strings["Contactinformation / Notes"] = "Kontaktníinformace / poznámky";
$a->strings["Online Reputation"] = "Online pověst";
$a->strings["Occasionally your friends may wish to inquire about this person's online legitimacy."] = "Občas mohou vaši přátelé chtítinformovat o online legitimitě této osoby.";
...
$a->strings["You receive anintroduction"] = "obdržíte žádost o propojení";
$a->strings["Yourintroductions are confirmed"] = "Vaše žádosti jsou potvrzeny";
...
$a->strings["Enter your email accessinformation on your Settings page if you wish to import AND interact with friends or mailing lists FROM your email INBOX"] = "na stránce Nastavení zadejteinformace pro přístup k Vaší e-mailové stránce, pokud si přejete importovat a komunikovat s přáteli nebo distribučními skupinami z Vaší e-mailové schránky";
...
$a->strings["Set some public keywords for your default profile which describe yourinterests. We may be able to find other people with similarinterests AND suggest friendships."] = "Nastavte si nějaká veřejné klíčová slova pro výchozí profil, která popisují vaše zájmy. Friendika Vám může nalézt další lidi s podobnými zájmy a navrhnout přátelství.";
...
$a->strings["Our <strong>help</strong> pages may be consulted for detail on other program features AND resources."] = "Na stránkách <strong>Nápověda</strong> naleznete nejen další podrobnosti o všech funkcích Friendika ale také další zdrojeinformací.";
...
$a->strings["Please enter the requiredinformation."] = "Zadejte prosím požadovanéinformace.";
...
$a->strings["Unable to locate contactinformation."] = "Nepodařilo se najít kontaktníinformace.";
...
$a->strings["The profile address specified does not provide adequateinformation."] = "Uvedená adresa profilu neposkytuje dostatečnéinformace.";
...
$a->strings["Unable to retrieve contactinformation."] = "Nepodařilo se získat kontaktníinformace.";
...
$a->strings["Contactinformation AND Social Networks"] = "Kontaktníinformace a sociální sítě";
$a->strings["Musicalinterests"] = "Hudební vkus";
