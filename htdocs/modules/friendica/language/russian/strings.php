...
$a->strings["<strong>WARNING: This is highly advanced</strong> AND if you enter incorrectinformation your communications with this contact will stop working."] = "<strong>ВНИМАНИЕ: Это крайне важно</strong> и если вы введете неверную информацию, ваша связь с этим контактом перестанет работать.";
...
$a->strings["Contactinformation unavailable"] = "Контактная информация недоступна";
...
$a->strings["Thisintroduction has already been accepted."] = "Эта краткая информация уже была принята.";
$a->strings["Profile location is not valid or does not contain profileinformation."] = "Местоположение профиля является недопустимым или не содержит информацию о профиле.";
...
$a->strings["You have alreadyintroduced yourself here."] = "Вы уже ввели информацию о себе здесь.";
...
$a->strings["Yourintroduction has been sent."] = "Ваша краткая информация отправлена.";
$a->strings["Please login to confirmintroduction."] = "Пожалуйста, войдите с паролем для подтверждения краткой информации.";
...
$a->strings["Please confirm yourintroduction/connection request to %s."] = "Пожалуйста, подтвердите краткую информацию / запрос на подключение к %s.";
...
$a->strings["Remote privacyinformation not available."] = "Личная информация удаленно недоступна.";
...
$a->strings["Find People With Sharedinterests"] = "Найти людей с общими интересами";
...
$a->strings["Contactinformation / Notes"] = "Контактная информация / Заметки";
...
$a->strings["You receive anintroduction"] = "Вы получаете краткую информацию";
$a->strings["Yourintroductions are confirmed"] = "Ваши сообщения с краткой информацией подтверждены";
...
$a->strings["Enter your email accessinformation on your Settings page if you wish to import AND interact with friends or mailing lists FROM your email INBOX"] = "";
...
$a->strings["Please enter the requiredinformation."] = "Пожалуйста, введите необходимую информацию.";
$a->strings["Please use a shorter name."] = "Пожалуйста, используйте более короткое имя.";
$a->strings["Name too short."] = "Имя слишком короткое.";
...
$a->strings["Unable to locate contactinformation."] = "Не удалось найти контактную информацию.";
...
$a->strings["The profile address specified does not provide adequateinformation."] = "Указанный адрес профиля не дает адекватной информации.";
...
$a->strings["Unable to retrieve contactinformation."] = "Невозможно получить контактную информацию.";
...
$a->strings["Contactinformation AND Social Networks"] = "Контактная информация и социальные сети";
$a->strings["Musicalinterests"] = "Музыкальные интересы";
