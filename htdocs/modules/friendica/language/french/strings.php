...
$a->strings["Page not found."] = "Pageintrouvable.";
...
$a->strings["The profile address specified does not provide adequateinformation."] = "L'adresse de profil indiquée ne fournit par lesinformations adéquates.";
...
$a->strings["Unable to retrieve contactinformation."] = "Impossible de récupérer lesinformations du contact.";
...
$a->strings["Profile not found."] = "Profilintrouvable.";
...
$a->strings["Contactinformation AND Social Networks"] = "Coordonées/Réseaux sociaux";
$a->strings["Musicalinterests"] = "Goûts musicaux";
...
$a->strings["Item not found."] = "Élémentintrouvable.";
$a->strings["everybody"] = "tout le monde";
$a->strings["Missing some important data!"] = "Il manque certainesinformations importantes!";
...
$a->strings["You receive anintroduction"] = "Vous recevez uneintroduction";
$a->strings["Yourintroductions are confirmed"] = "Vosintroductions sont confirmées";
...
$a->strings["Contactinformation unavailable"] = "Informations de contact indisponibles";
$a->strings["Album not found."] = "Albumintrouvable.";
...
$a->strings["Set some public keywords for your default profile which describe yourinterests. We may be able to find other people with similarinterests AND suggest friendships."] = "Choisissez quelques mots-clé publics pour votre profil par défaut. Ils pourront ainsi décrire vos centres d'intérêt, et nous pourrons vous proposer des contacts qui les partagent.";
...
$a->strings["Contactinformation / Notes"] = "Informations de contact / Notes";
...
$a->strings["Remote privacyinformation not available."] = "Informations de confidentialité indisponibles.";
...
$a->strings["Please enter the requiredinformation."] = "Entrez lesinformations requises.";
...
$a->strings["Contact not found."] = "Contactintrouvable.";
$a->strings["Repair contact Settings"] = "Réglages du réparateur de contacts";
$a->strings["<strong>WARNING: This is highly advanced</strong> AND if you enter incorrectinformation your communications with this contact may stop working."] = "<strong>ATTENTION: Manipulation réservée aux experts</strong>, touteinformation incorrecte pourrait empêcher la communication avec ce contact.";
...
$a->strings["Thisintroduction has already been accepted."] = "Cetteintroduction a déjà été acceptée.";
$a->strings["Profile location is not valid or does not contain profileinformation."] = "L'emplacement du profil est invalide ou ne contient pas de profil valide.";
...
$a->strings["You have alreadyintroduced yourself here."] = "Vous vous êtes déjà présenté ici.";
...
$a->strings["Yourintroduction has been sent."] = "Votre présentation a été envoyée.";
$a->strings["Please login to confirmintroduction."] = "Connectez-vous pour confirmer l'introduction.";
...
$a->strings["Please confirm yourintroduction/connection request to %s."] = "Merci de confirmer votre demande d'introduction auprès de %s.";
$a->strings["Confirm"] = "Confirmer";
...
$a->strings["Unable to locate contactinformation."] = "Impossible de localiser lesinformations du contact.";
...
$a->strings["Group not found."] = "Groupeintrouvable.";
...
$a->strings["Item was not found."] = "Elementintrouvable.";
...
$a->strings["image/photo"] = "image/photo";
$a->strings["Cannot locate DNS info for database server %s"] = "Impossible de localiser lesinformations DNS pour le serveur de base de données %s";
